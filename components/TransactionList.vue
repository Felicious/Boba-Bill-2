...
export default {
  ...
  components: {
    ...
    // FriendList is not a component bc it's not being used in
    // the template, but an array from it, friends, is being
    // imported and used. Defined this behavior using mount()
    // TODO: don't rly get mount() yet, so figure this out later
  },
